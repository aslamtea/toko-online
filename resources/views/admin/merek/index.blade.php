    ...
    <!-- Page Heading -->
      <div class="row justify-content-center">
        <div class="col-11">
            ...
            <div class="card-body">
            <a href="/admin/merek/create" class="btn btn-primary my-3">Tambah Merek</a>
            <table class="table table-striped table-bordered bg-light table-sm" id="dataTable" style="width: 100%">
                ...
                {{-- <tbody>
                    ...
                    @foreach ($merek as $merek)
                        ...
                        <td>{{$merek->name}}</td>
                            <td>
                            <a href="/admin/merek/{{$merek->id}}/edit" class="badge badge-success">edit</a>
                            <form action="/admin/merek/{{$merek->id}}" method="POST" class="d-inline" id="hapus-ey">
                                @method('delete')
                                @csrf
